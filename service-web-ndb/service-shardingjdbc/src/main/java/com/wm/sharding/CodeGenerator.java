...
public class CodeGenerator {
    ...
    private static final String MODULE_NAME = "service-shardingjdbc";
...
//		gc.setIdType(IdType.NONE);
        ...
        pc.setParent(null);
        pc.setEntity("com.wm.sharding.model.entity");
        ...
        if ("1".equals(generateCaS)) {
            ...
            pc.setServiceImpl("com.wm.sharding.service.impl");   //本项目没用，生成之后删掉
            pc.setController("com.wm.sharding.controller");
        } else {
